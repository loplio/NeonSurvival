...
/*	SceneServer															   */
//-------------------------------------------------------------------------------
SceneServer_Neon::SceneServer_Neon(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList) : CScene(pd3dDevice, pd3dCommandList)
{
}

void SceneServer_Neon::CreateShaderVariables(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	CScene::CreateShaderVariables(pd3dDevice, pd3dCommandList);
}
void SceneServer_Neon::UpdateShaderVariables(ID3D12GraphicsCommandList* pd3dCommandList)
{
	CScene::UpdateShaderVariables(pd3dCommandList);
}
void SceneServer_Neon::ReleaseShaderVariables()
{
	CScene::ReleaseShaderVariables();
}

//--Build : SceneServer_Neon---------------------------------------------------------------
void SceneServer_Neon::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	BuildLightsAndMaterials();
...
void SceneServer_Neon::BuildLightsAndMaterials()
{
	CScene::BuildLightsAndMaterials();
...
void SceneServer_Neon::ReleaseUploadBuffers()
{
	CScene::ReleaseUploadBuffers();
}
void SceneServer_Neon::ReleaseObjects()
{
	CScene::ReleaseObjects();
}

//--ProcessInput : SceneServer_Neon--------------------------------------------------------
bool SceneServer_Neon::OnProcessingMouseMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	return false;
}
bool SceneServer_Neon::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM lParam)
{
	switch (nMessageID)
	{
	case WM_KEYDOWN:
...
//--ProcessAnimation : SceneServer_Neon----------------------------------------------------
void SceneServer_Neon::AnimateObjects(float fTimeElapsed)
{
	CScene::AnimateObjects(fTimeElapsed);
}

//--ProcessOutput : SceneServer_Neon-------------------------------------------------------
void SceneServer_Neon::OnPrepareRender(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	CScene::OnPrepareRender(pd3dCommandList, pCamera);
}
void SceneServer_Neon::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	CScene::Render(pd3dCommandList, pCamera);
}
void SceneServer_Neon::DrawUI(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	CScene::DrawUI(pd3dCommandList, pCamera);
