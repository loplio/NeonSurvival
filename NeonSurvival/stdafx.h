...
#define DRAW_SCENE_ROUGHNESS			'R'
//#define DRAW_SCENE_Z_DEPTH			'Z'
#define DRAW_SCENE_DEPTH				'Z'
...
#define FORWARD_W 0x57
#define BACKWARD_S 0x53
#define LEFT_A 0x41
#define RIGHT_D 0x44

#define BACKBUFFER_NUM 6
#define BACKBUFFER_NUM_INCLUDE_FLIP 7
...
extern ID3D12Resource* CreateTextureResource(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, void* pData, UINT nBytes,
	D3D12_RESOURCE_DIMENSION d3dResourceDimension, UINT nWidth, UINT nHeight, UINT nDepthOrArraySize, UINT nMipLevels, D3D12_RESOURCE_FLAGS d3dResourceFlags, DXGI_FORMAT dxgiFormat, D3D12_HEAP_TYPE d3dHeapType, D3D12_RESOURCE_STATES d3dResourceStates, ID3D12Resource** ppd3dUploadBuffer, ID3D12Resource* d3dRtvResource = NULL);
