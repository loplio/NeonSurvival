...
void SERVER::SendPlayerData(CPlayer& player,int GunType, float flength, int anibundle)
{
    ...
    P_InGame2.bEnable = player.m_pSkinnedAnimationController->m_SubAnimationTrack.m_bEnable;
    P_InGame2.nAnimationSet = player.m_pSkinnedAnimationController->m_SubAnimationTrack.m_nAnimationSet;
